...
const WHISPER_BTP_PROMPT = [
  ...
  "Vocabulaire : dalle, coffrage, décoffrage, ciment, béton, béton armé, béton précontraint,",
  "béton désactivé, béton ciré, béton fibré, béton autoplaçant, BHP, BAP,",
  "ferraillage, ferraille, armature, acier, treillis soudé, chaînage, épingle, cadre,",
  "parpaing, agglo, bloc à bancher, bloc béton, brique, brique plâtrière, brique monomur,",
  "moellon, pierre de taille, pierre calcaire, granit,",
  "fondation, semelle, semelle filante, semelle isolée, radier, micropieu, pieu, palplanche,",
  "longrine, poutrelle, hourdis, prédalle, préfabriqué, prémur,",
  "plancher, plancher collaborant, plancher alvéolaire, vide sanitaire,",
  "hérisson, remblai, déblai, terrassement, décaissement, nivelage, nivellement,",
  "talus, fouille, fouille en rigole, fouille en pleine masse,",
  "mur de soutènement, mur banché, mur porteur, refend, voile béton,",
  "poteau, pilier, pilotis, jambe de force, contreventement,",
  "linteau, chaînage horizontal, chaînage vertical, about de dalle,",
  "joint de dilatation, joint de fractionnement, réservation,",
  "coffrage grimpant, coffrage glissant, coffrage tunnel, banche,",
  "décintrage, étaiement, cintrage, forme de pente,",
  // ── Charpente / Couverture / Toiture ──
  "charpente, charpente bois, charpente métallique, fermette, pannes, faîtage,",
  "chevron, liteaux, voliges, lambourde, solive, madrier, bastaing,",
  "couverture, ardoise, tuile, tuile mécanique, tuile canal, zinc, bac acier,",
  "membrane d'étanchéité, membrane EPDM, bitume, gouttière, descente EP,",
  "chéneau, noue, arêtier, rive, solin, abergement, ventilation de toiture,",
  "lucarne, velux, châssis de toit, lanterneau, faîtière, sous-face,",
  "zinguerie, couvertine, acrotère, toiture-terrasse, végétalisation,",
  // ── Maçonnerie / Façade ──
  "enduit, crépi, monocouche, enduit projeté, enduit gratté, enduit taloché,",
  "gobetis, corps d'enduit, enduit de finition, ravalement, sablage,",
  "rejointoiement, joint, joint de pierre, joint à la chaux,",
  "chape, ragréage, chape fluide, chape anhydrite, chape fibré,",
  "égalisation, lissage, surfaçage, ponçage, bouchardage,",
  "ITE, isolation thermique par l'extérieur, bardage, parement, vêture,",
  "polystyrène, PSE, laine de roche, mousse polyuréthane, mousse phénolique,",
  "panneau sandwich, panneau composite, fixation mécanique, calage-collage,",
  // ── Étanchéité ──
  "étanchéité, cuvelage, imperméabilisation, drainage, drain français,",
  "géotextile, géomembrane, barbacane, delta MS, émulsion bitumineuse,",
  "primaire d'accrochage, résine, résine époxy, résine polyuréthane,",
  // ── Plomberie / Chauffage / CVC ──
  "PER, multicouche, cuivre, PVC, tube PVC, raccord, soudure, brasure,",
  "colonne montante, colonne d'eau, collecteur, nourrice, vanne, robinet,",
  "chauffe-eau, cumulus, ballon thermodynamique, chaudière, chaudière gaz,",
  "chaudière condensation, pompe à chaleur, PAC, PAC air-eau, PAC air-air,",
  "plancher chauffant, radiateur, sèche-serviettes, calorstat, thermostat,",
  "VMC, VMC simple flux, VMC double flux, gaine VMC, bouche d'extraction,",
  "climatisation, gainable, split, cassette, groupe extérieur,",
  "tout-à-l'égout, assainissement, fosse septique, micro-station,",
  "siphon, évacuation, regard, collecteur EU, collecteur EP, séparateur,",
  "pompe de relevage, surpresseur, réducteur de pression, anti-bélier,",
  "disconnecteur, compteur d'eau, nourrice, piquage, té, coude, manchon,",
  // ── Électricité / Courant faible ──
  "tableau électrique, disjoncteur, différentiel, inter diff, contacteur,",
  "gaine ICTA, goulotte, chemin de câble, moulure, plinthe électrique,",
  "prise, interrupteur, va-et-vient, télérupteur, minuterie, variateur,",
  "câble, fil, section, terre, mise à la terre, piquet de terre,",
  "encastré, saillie, boîte d'encastrement, DCL, point lumineux,",
  "spot, LED, éclairage, réglette, luminaire, projecteur, hublot,",
  "GTL, ETEL, espace technique, coffret de communication, baie de brassage,",
  "fibre optique, RJ45, prise RJ, courant faible, alarme, vidéophone,",
  "domotique, KNX, interphone, visiophone, portier vidéo,",
  "photovoltaïque, panneau solaire, onduleur, micro-onduleur, autoconsommation,",
  "borne de recharge, IRVE, prise Green'Up, câble type 2,",
  // ── Plâtrerie / Cloison ──
  "placo, plaque de plâtre, BA13, BA15, BA18, plaque hydro, plaque feu,",
  "rail, montant, fourrure, suspente, ossature métallique,",
  "cloison, cloison alvéolaire, cloison distributive, cloison séparative,",
  "doublage, isolation, laine de verre, laine de roche, isolant mince,",
  "ouate de cellulose, fibre de bois, liège, chanvre, biosourcé,",
  "faux plafond, plafond suspendu, dalles de plafond, plafond acoustique,",
  "bande à joint, calicot, enduit de lissage, enduit de rebouchage,",
  "trappe de visite, cornière, raccord placo, vis placo, cheville à frapper,",
  // ── Menuiserie / Fermeture ──
  "menuiserie, huisserie, porte, porte intérieure, porte palière, bloc-porte,",
  "porte blindée, porte coupe-feu, porte vitrée, porte coulissante, galandage,",
  "fenêtre, fenêtre PVC, fenêtre alu, fenêtre bois, mixte bois-alu,",
  "baie vitrée, baie coulissante, porte-fenêtre, châssis fixe, imposte,",
  "double vitrage, triple vitrage, vitrage feuilleté, vitrage trempé,",
  "volet, volet roulant, volet battant, persienne, brise-soleil,",
  "store, store banne, store intérieur, moustiquaire, grille de ventilation,",
  "appui de fenêtre, seuil, rejingot, dormant, ouvrant, paumelle, gond,",
  "serrure, cylindre, poignée, crémone, béquille, ferme-porte, groom,",
  "portail, portillon, clôture, grillage, occultant, lame, motorisation,",
  "veranda, pergola, auvent, marquise, garde-corps, balustrade, rambarde,",
  // ── Carrelage / Sol / Revêtement ──
  "carrelage, faïence, grès cérame, mosaïque, tomette, pierre naturelle,",
  "colle carrelage, mortier-colle, croisillons, joint de carrelage,",
  "parquet, parquet massif, parquet contrecollé, parquet stratifié, lame PVC,",
  "lino, sol souple, moquette, jonc de mer, résine de sol,",
  "plinthe, nez de marche, seuil de porte, barre de seuil,",
  "sous-couche, primaire, ragréage auto-lissant, fibre de verre,",
  // ── Peinture / Finitions ──
  "peinture, peinture acrylique, peinture glycéro, peinture satinée,",
  "sous-couche, primaire d'accrochage, fixateur, impression,",
  "laque, vernis, lasure, huile, cire, patine, badigeon,",
  "papier peint, toile de verre, fibre de verre à peindre,",
  "enduit de lissage, enduit de rebouchage, mastic, silicone, acrylique,",
  "ponçage, égrenage, lessivage, décapage, dégraissage,",
  // ── VRD / Voirie / Réseaux ──
  "VRD, voirie et réseaux divers, enrobé, bitume, goudron, goudronnage,",
  "caniveau, bordure, bordure T2, bordure P1, pavé, dalle podotactile,",
  "regard, tampon, réseau EU, réseau EP, réseau AEP, réseau gaz,",
  "fourreau, gaine TPC, chambre de tirage, borne, bouche à clé,",
  "raccordement, branchement, tranchée, lit de pose, sable de pose,",
  "compactage, grave, GNT, tout-venant, concassé, gravier, gravillons,",
  "assainissement, eaux pluviales, eaux usées, décanteur, déshuileur,",
  "noue paysagère, bassin de rétention, bassin d'orage, puisard,",
  "trottoir, chaussée, accotement, plateau ralentisseur, giratoire,",
  // ── Terrassement / Démolition ──
  "terrassement, nivellement, remblai, déblai, décapage, dessouchage,",
  "démolition, déconstruction, curage, désamiantage, déplombage,",
  "sciage, carottage, découpage, rabotage, concassage, tri sélectif,",
  "benne, évacuation gravats, déchets inertes, DIB, amiante, plomb,",
  // ── Matériel / Engins ──
  "mini-pelle, pelleteuse, pelle mécanique, chargeuse, bobcat,",
  "tractopelle, dumper, camion-benne, semi-remorque, porte-engins,",
  "grue, grue à tour, grue mobile, grue télescopique, flèche,",
  "nacelle, PEMP, nacelle ciseaux, nacelle articulée, nacelle araignée,",
  "échafaudage, échafaudage tubulaire, échafaudage roulant, PIR,",
  "compacteur, plaque vibrante, pilonneuse, rouleau compresseur,",
  "bétonnière, toupie, pompe à béton, malaxeur, aiguille vibrante,",
  "disqueuse, meuleuse, perforateur, perceuse, burineur, marteau-piqueur,",
  "visseuse, cloueur, agrafeuse, scie circulaire, scie sauteuse,",
  "niveau laser, théodolite, station totale, GPS de chantier,",
  "groupe électrogène, compresseur, nettoyeur haute pression, Karcher,",
  "brouette, diable, transpalette, chariot élévateur, monte-matériaux,",
  "étai, étaiement, tire-fort, treuil, palan, élingue, manille,",
  "serre-joint, pince à décoffrer, aiguille de coffrage, tige filetée,",
  // ── Sécurité / Réglementation ──
  "PPSPS, PGC, DOE, DIUO, DICT, permis de construire, déclaration préalable,",
  "maître d'ouvrage, maître d'œuvre, conducteur de travaux, chef de chantier,",
  "sous-traitant, intérimaire, compagnon, manœuvre, apprenti,",
  "OPC, coordination, planning, GANTT, chemin critique, lot, phase,",
  "réception, réserves, levée de réserves, garantie décennale, CCTP,",
  "DQE, DPGF, avenant, situation de travaux, décompte, attachement,",
  "protections collectives, garde-corps, filet de sécurité, balisage,",
  "EPI, casque, gants, chaussures de sécurité, harnais, longe,",
  "signalisation, panneau de chantier, clôture de chantier, base vie,",
  "bungalow, Algeco, sanitaire, vestiaire, réfectoire,",
  "livraison, approvisionnement, calepinage, métré, quantitatif,",
  "retard, avance, pénalité, intempéries, arrêt de chantier,",
  "fissure, malfaçon, non-conformité, reprise, réparation,",
  "AT, accident du travail, incident, presqu'accident, quart d'heure sécurité.",
...
const BTP_CORRECTIONS: [RegExp, string][] = [
  ...
  [/\bparpaint?\b/gi, "parpaing"],
  [/\bparpoing\b/gi, "parpaing"],
  [/\bagglos?\b/gi, "agglo"],
  [/\baglo\b/gi, "agglo"],
  [/\bferaille\b/gi, "ferraille"],
  [/\bferraillage\b/gi, "ferraillage"],
  [/\bféraillage\b/gi, "ferraillage"],
  [/\bferaillage\b/gi, "ferraillage"],
  [/\btreillis?\s*soudée?\b/gi, "treillis soudé"],
  // ── Coffrage / Structure ──
  [/\bcofrage\b/gi, "coffrage"],
  [/\bcaufrage\b/gi, "coffrage"],
  [/\bdécofrage\b/gi, "décoffrage"],
  ...
  [/\bbasting\b/gi, "bastaing"],
  [/\bchèvron\b/gi, "chevron"],
  [/\blongr[ie]ne?\b/gi, "longrine"],
  [/\bpoutr[ae]lle?\b/gi, "poutrelle"],
  [/\bhour?dis?\b/gi, "hourdis"],
  [/\bpré ?dalle\b/gi, "prédalle"],
  // ── Tranchée / Terrassement ──
  [/\btrancher\b/gi, "tranchée"],
  [/\btranchais?\b/gi, "tranchée"],
  [/\btranchée?\b/gi, "tranchée"],
  [/\bterrassement?\b/gi, "terrassement"],
  [/\bterassement\b/gi, "terrassement"],
  [/\bdéblais?\b/gi, "déblai"],
  [/\bremblais?\b/gi, "remblai"],
  [/\bharisson\b/gi, "hérisson"],
  [/\bherisson\b/gi, "hérisson"],
  [/\bhairisson\b/gi, "hérisson"],
  // ── Fondations ──
  [/\bsemell?e?\b/gi, "semelle"],
  [/\bradié\b/gi, "radier"],
  [/\bmicro ?pieu\b/gi, "micropieu"],
  [/\bpalplanche?\b/gi, "palplanche"],
  // ── Plâtrerie / Cloison ──
  [/\bplaco\b/gi, "placo"],
  [/\bplacco\b/gi, "placo"],
  [/\bplacko\b/gi, "placo"],
  ...
  [/\bba 13\b/gi, "BA13"],
  [/\bbé ?a ?treize\b/gi, "BA13"],
  [/\bba quinze\b/gi, "BA15"],
  [/\bba 15\b/gi, "BA15"],
  [/\braille?\b/gi, "rail"],
  [/\bfaux ?plafond\b/gi, "faux plafond"],
  [/\bcalicot?\b/gi, "calicot"],
  // ── Isolation ──
  [/\blaine?\s*de?\s*verre?\b/gi, "laine de verre"],
  [/\blaine?\s*de?\s*roche?\b/gi, "laine de roche"],
  [/\bpolyuréthane?\b/gi, "polyuréthane"],
  [/\bpolystyrène?\b/gi, "polystyrène"],
  [/\bpse\b/gi, "PSE"],
  [/\bouate?\s*de?\s*cellulose?\b/gi, "ouate de cellulose"],
  // ── Enduit / Façade ──
  [/\benduis?\b/gi, "enduit"],
  [/\bcrépi[es]?\b/gi, "crépi"],
  [/\bravalement?\b/gi, "ravalement"],
  [/\bmonocouche?\b/gi, "monocouche"],
  [/\bgobeti\b/gi, "gobetis"],
  [/\bITE\b/g, "ITE"],
  [/\bi\.t\.e\.?\b/gi, "ITE"],
  [/\bite\b/g, "ITE"],
  // ── Chape / Sol ──
  ...
  [/\bragreyage\b/gi, "ragréage"],
  [/\bcarelage\b/gi, "carrelage"],
  [/\bcarrelage?\b/gi, "carrelage"],
  [/\bfaïence?\b/gi, "faïence"],
  [/\bfayence\b/gi, "faïence"],
  [/\bgrès\s*cérame?\b/gi, "grès cérame"],
  // ── Étanchéité ──
  [/\bétanchéité?\b/gi, "étanchéité"],
  [/\betancheite\b/gi, "étanchéité"],
  [/\bétanchéite\b/gi, "étanchéité"],
  [/\bcuvelage?\b/gi, "cuvelage"],
  [/\bgéotextile?\b/gi, "géotextile"],
  [/\bgeotextile\b/gi, "géotextile"],
  [/\bdelta ?\bms?\b/gi, "delta MS"],
  [/\be\.?p\.?d\.?m\.?\b/gi, "EPDM"],
  // ── Plomberie / CVC ──
  [/\bper\b/gi, "PER"],
  [/\bp\.e\.r\.?\b/gi, "PER"],
  [/\bmulticouche?\b/gi, "multicouche"],
  [/\bcuivre?\b/gi, "cuivre"],
  [/\bchauffe?\s*eau\b/gi, "chauffe-eau"],
  [/\bcumulus?\b/gi, "cumulus"],
  [/\bchaudière?\b/gi, "chaudière"],
  [/\bchaudiere\b/gi, "chaudière"],
  [/\bpompe?\s*[àa]?\s*chaleur\b/gi, "pompe à chaleur"],
  [/\bpac\b/gi, "PAC"],
  [/\bp\.a\.c\.?\b/gi, "PAC"],
  [/\bvmc\b/gi, "VMC"],
  [/\bv\.m\.c\.?\b/gi, "VMC"],
  ...
  [/\bsplit?\b/gi, "split"],
  [/\bgainable?\b/gi, "gainable"],
  [/\bfosse?\s*septique?\b/gi, "fosse septique"],
  [/\bassainissement?\b/gi, "assainissement"],
  [/\bsurpresseur?\b/gi, "surpresseur"],
  // ── Électricité ──
  [/\bdisjonteur\b/gi, "disjoncteur"],
  [/\bdisjoncteur?\b/gi, "disjoncteur"],
  [/\bdifférentiel?\b/gi, "différentiel"],
  [/\binter?\s*diff\b/gi, "inter diff"],
  [/\bgaine?\s*icta\b/gi, "gaine ICTA"],
  [/\bicta\b/gi, "ICTA"],
  [/\bgoulotte?\b/gi, "goulotte"],
  [/\bva ?et ?vient\b/gi, "va-et-vient"],
  [/\btélérupteur?\b/gi, "télérupteur"],
  [/\bdcl\b/gi, "DCL"],
  [/\bd\.c\.l\.?\b/gi, "DCL"],
  [/\bgtl\b/gi, "GTL"],
  [/\betel\b/gi, "ETEL"],
  [/\brj ?45\b/gi, "RJ45"],
  [/\bphotovoltaïque?\b/gi, "photovoltaïque"],
  [/\bonduleur?\b/gi, "onduleur"],
  [/\birve\b/gi, "IRVE"],
  // ── Menuiserie / Fermeture ──
  [/\bhuisserie?\b/gi, "huisserie"],
  [/\bdormant?\b/gi, "dormant"],
  [/\bouvrant?\b/gi, "ouvrant"],
  [/\bgalandage?\b/gi, "galandage"],
  [/\bdouble?\s*vitrage?\b/gi, "double vitrage"],
  [/\btriple?\s*vitrage?\b/gi, "triple vitrage"],
  [/\bvolet?\s*roulant?\b/gi, "volet roulant"],
  [/\bpersienne?\b/gi, "persienne"],
  [/\bpergola\b/gi, "pergola"],
  [/\bgarde?\s*corps?\b/gi, "garde-corps"],
  [/\brambarde?\b/gi, "rambarde"],
  // ── VRD / Voirie ──
  [/\bvrd\b/gi, "VRD"],
  [/\bv\.r\.d\.?\b/gi, "VRD"],
  [/\benrobé[es]?\b/gi, "enrobé"],
  [/\bgoudronnage?\b/gi, "goudronnage"],
  [/\bcaniveau?\b/gi, "caniveau"],
  [/\bbordure?\b/gi, "bordure"],
  [/\bfourreau?\b/gi, "fourreau"],
  [/\bgaine?\s*tpc\b/gi, "gaine TPC"],
  [/\btpc\b/gi, "TPC"],
  [/\bgnt\b/gi, "GNT"],
  [/\btout[\s-]?venant\b/gi, "tout-venant"],
  [/\bconcassé?\b/gi, "concassé"],
  // ── Toiture / Charpente ──
  [/\bcharpente?\b/gi, "charpente"],
  [/\bfermette?\b/gi, "fermette"],
  [/\bfaîtage?\b/gi, "faîtage"],
  [/\bfaitag\b/gi, "faîtage"],
  [/\bardoise?\b/gi, "ardoise"],
  [/\btuile?\b/gi, "tuile"],
  [/\bgouttière?\b/gi, "gouttière"],
  [/\bgoutière\b/gi, "gouttière"],
  [/\bchéneau?\b/gi, "chéneau"],
  [/\bzinguerie?\b/gi, "zinguerie"],
  [/\bacrotère?\b/gi, "acrotère"],
  [/\bvelux\b/gi, "Velux"],
  // ── Peinture / Finitions ──
  [/\bpeinture?\b/gi, "peinture"],
  [/\bacrylique?\b/gi, "acrylique"],
  [/\bglycéro?\b/gi, "glycéro"],
  [/\blasure?\b/gi, "lasure"],
  [/\bsilicone?\b/gi, "silicone"],
  [/\bmastic?\b/gi, "mastic"],
  // ── Matériel / Engins ──
  [/\bmini[\s-]?pelle\b/gi, "mini-pelle"],
  [/\bpelleteuse?\b/gi, "pelleteuse"],
  [/\btractopelle?\b/gi, "tractopelle"],
  [/\bbobcat?\b/gi, "bobcat"],
  [/\bdumper?\b/gi, "dumper"],
  [/\bnacelle?\b/gi, "nacelle"],
  [/\béchafaudage?\b/gi, "échafaudage"],
  [/\bechafaudage\b/gi, "échafaudage"],
  [/\btoupille?\b/gi, "toupie"],
  [/\bbétonnière?\b/gi, "bétonnière"],
  [/\bbetonniere\b/gi, "bétonnière"],
  [/\bdisqueuse?\b/gi, "disqueuse"],
  [/\bmeuleuse?\b/gi, "meuleuse"],
  [/\bperfo\b/gi, "perforateur"],
  [/\bperforateur?\b/gi, "perforateur"],
  [/\bburineur?\b/gi, "burineur"],
  [/\bmarteau[\s-]?piqueur\b/gi, "marteau-piqueur"],
  [/\bcompacteur?\b/gi, "compacteur"],
  [/\bplaque?\s*vibrante?\b/gi, "plaque vibrante"],
  [/\bpilonneuse?\b/gi, "pilonneuse"],
  [/\bkarcher\b/gi, "Karcher"],
  [/\bkarsher\b/gi, "Karcher"],
  [/\bgroupe?\s*électrogène?\b/gi, "groupe électrogène"],
  [/\bcompresseur?\b/gi, "compresseur"],
  [/\bgrue\b/gi, "grue"],
  [/\btranspalette?\b/gi, "transpalette"],
  [/\bmonte[\s-]?matériaux\b/gi, "monte-matériaux"],
  [/\bniveau?\s*laser\b/gi, "niveau laser"],
  // ── Sécurité / Admin ──
  [/\bppsps\b/gi, "PPSPS"],
  [/\bp\.p\.s\.p\.s\.?\b/gi, "PPSPS"],
  [/\bpgc\b/gi, "PGC"],
  [/\bdoe\b/gi, "DOE"],
  [/\bdiuo\b/gi, "DIUO"],
  [/\bdict\b/gi, "DICT"],
  ...
  [/\bepi\b/gi, "EPI"],
  [/\be\.p\.i\.?\b/gi, "EPI"],
  [/\bharnais?\b/gi, "harnais"],
  [/\balgeco\b/gi, "Algeco"],
  [/\bbungalow?\b/gi, "bungalow"],
  [/\bbase?\s*vie\b/gi, "base vie"],
  [/\bmalfaçon?\b/gi, "malfaçon"],
  [/\bmalfacon\b/gi, "malfaçon"],
  [/\bréserve?\b/gi, "réserve"],
  [/\bgarantie?\s*décennale?\b/gi, "garantie décennale"],
  [/\bdécennale?\b/gi, "décennale"],
  [/\bmaître?\s*d'?\s*[oœ]euvre?\b/gi, "maître d'œuvre"],
  [/\bconducteur?\s*de?\s*travaux\b/gi, "conducteur de travaux"],
  [/\bchef?\s*de?\s*chantier\b/gi, "chef de chantier"],
  [/\bsous[\s-]?traitant?\b/gi, "sous-traitant"],
  [/\bintérimaire?\b/gi, "intérimaire"],
  [/\binterimaire\b/gi, "intérimaire"],
  [/\bcompagnon?\b/gi, "compagnon"],
];
